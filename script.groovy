...
def deployApp() {
    ...
    sh 'cd ..'
    sh 'sshpass "PPPdevops2022!" scp -r ./deployment localuser@40.114.225.176:/home/localuser/Bookstore/'
    sh 'sshpass "PPPdevops2022" ssh localuser@40.114.225.176 cd Bookstore && docker-compose up'
}
