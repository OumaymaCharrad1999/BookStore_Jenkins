...
def deployApp() {
    ...
    sh 'cd ..'
    sh 'sshpass -p \"PPPdevops2022!\" scp -r ./deployment/ deployuser@20.127.122.203:/home/deployuser/Bookstore/'
    sh 'sshpass -p \"PPPdevops2022!\" ssh deployuser@20.127.122.203 \"cd /home/deployuser/Bookstore/deployment && docker-compose up\"'
}
